...
module.exports.displayHomePage = (req, res, next) => {
    res.render('index', {title: 'Home', displayName: req.guestUser ? req.guestUser.displayName: ''});
}

/* DISPLAY projects page. */
module.exports.displayProjectsPage = (req, res, next) => {
    res.render('projects', { title: 'Projects', displayName: req.guestUser ? req.guestUser.displayName: '' });
}

/* DISPLAY services page. */
module.exports.displayServicesPage = (req, res, next) => {
    res.render('services', { title: 'Services', displayName: req.guestUser ? req.guestUser.displayName: '' });
}

/* DISPLAY home page. */
module.exports.displayAboutMePage = (req, res, next) => {
    res.render('aboutme', { title: 'About Me', displayName: req.guestUser ? req.guestUser.displayName: '' });
}

/* DISPLAY contact page. */
module.exports.displayContactMePage = (req, res, next) => {
    res.render('contactme', { title: 'Contact Me', displayName: req.guestUser ? req.guestUser.displayName: '' });
}
...
module.exports.processRegisterPage = (req, res, next) => {
    ...
    guestUser.register(newGuestUser, req.body.password, (err) => {
        if(err) {
