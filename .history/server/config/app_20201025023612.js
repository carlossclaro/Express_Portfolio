...
let guestModel = require('../models/guestModel');
let guestUsers = guestModel.guestUsers;

// implement a User Authentication Strategy
passport.use(guestUsers.createStrategy());

//Serialize and deserialize (encrpyt and decrypt) guest infro 
passport.serializeUser(guestUsers.serializeUser());
passport.deserializeUser(guestUsers.deserializeUser());
